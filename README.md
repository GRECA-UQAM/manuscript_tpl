This is a minimal example of a scientific manuscript template using [**RMarkdown**](https://rmarkdown.rstudio.com/) and [**bookdown**](https://github.com/rstudio/bookdown).
